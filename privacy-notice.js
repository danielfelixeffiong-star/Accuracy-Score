(() => {
  const key = 'accuracy-score-privacy-notice-v1';
  ...
  </style><div class="box"><h2>Cookies &amp; privacy</h2><p>We use browser storage to remember that you have seen this notice. Secure sign-in may also use browser storage. These pages do not currently use advertising or analytics cookies. External links have their own privacy practices. <a href="/privacy.html">Read our Privacy Policy</a>.</p><button type="button">Understood</button></div>`;
